...
public class ContainerValidationIntegrationTest {
    ...
    public void whenValidationWithValidMethodParameters_thenNoException() {
        reservationManagement.createReservation(LocalDate.now().plusDays(1), 1, new Customer("William", "Smith"));
    }
    ...
    public void whenCrossParameterValidationWithValidParameters_thenNoException() {
        reservationManagement.createReservation(LocalDate.now().plusDays(1), LocalDate.now().plusDays(2), new Customer("William", "Smith"));
    }
