...
public class ApplicationTests {
    ...
    public void shouldRegisterClientInEurekaServer() throws InterruptedException {
        ...
        ResponseEntity<String> response = this.testRestTemplate.getForEntity("http://localhost:" + this.port + "/service-instances/eureka-1-client", String.class);

        then(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        then(response.getBody()).contains("eureka-1-client");
    }
