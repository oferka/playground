...
public class DefaultPageObserver implements PageObserver {
    ...
    public void observe(WebDriver driver, Pages page) {
        ...
        log.info("Observe page '{}' started", pageName);
        ...
        log.info("Observe page '{}' completed", pageName);
    }

    private void observe(WebDriver driver, Pages page, String filterValue, String timePeriodValue) {
        String pageName = page.getName();
        log.info("Observe page '{}' with filter '{}' and time period '{}' started", pageName, filterValue, timePeriodValue);
        ...
        log.info("Observe page '{}' with filter '{}' and time period '{}' completed", pageName, filterValue, timePeriodValue);
    }
